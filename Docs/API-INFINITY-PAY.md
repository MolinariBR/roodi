# DOCUMENTAÇÃO INFINITY PAY PAGAMENTOS

## DESCRIÇÃO
Documentação interativa: https://www.infinitepay.io/checkout
...
1. Vendedor: É você, o dono do site de vendas
2. Comprador: A pessoa que vai fazer a compra
3. Handle: Sua InfiniteTag, que é seu nome de usuário no App InfinitePay (use ela sem o símbolo $ do início)
4. order_nsu: É basicamente o número do pedido no seu sistema
